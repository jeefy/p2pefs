...
parser.add_argument("-f", "--file",    dest="file",                                help="Path to file")
parser.add_argument("-u", "--uuid",    dest="uuid",                                help="UUID of p2pfes files")
parser.add_argument("-e", "--encrypt", dest="encrypt",                             help="Encrypt and break apart file to p2pfes files")
parser.add_argument("-d", "--decrypt", dest="decrypt",                             help="Decrypt and join p2pfes files into new file")
...
if encrypt in args:
    ...
    response = "Must set -e or -d option"